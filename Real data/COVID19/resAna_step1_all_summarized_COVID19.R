...
#dir = "/gpfs/research/chongwu/Chong/CARE/New/COVID19/smmry_res5"
...
CARE.res[,c("setting.nIV","IV.BIC","IV.AIC")]

colSums(CARE.res<0.05/100,na.rm=TRUE)

#colSums(CARE.res<0.01,na.rm=TRUE)


cor(CARE.res[,"prune_p"],CARE.res[,"prune2_p"])
#,"prune_org_theta","prune_org_se","prune_org_p"
...
#colSums(CARE.res<0.05/150,na.rm=TRUE)

CARE.res[CARE.res[,"BIC.Efron_p"]<0.5/100,]
#CARE.res[CARE.res[,"AIC.Efron_p"]<0.5/150,]
